...
void TextGeneration::MakingTheTable(std::string text) {
...
std::string TextGeneration::NewText() {
prefix str;
...
std::string TextGeneration::ReadFromFile(std::string filename) {
std::string world;
std::string text = "";
...
TextGeneration::TextGeneration(std::map<prefix, std::vector<std::string> > val,
